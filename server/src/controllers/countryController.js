      ...
      if (existing) {
        ...
        await Country.findOneAndUpdate(
          { id: countryData.id.toUpperCase() },
          {
            ...
            oneSentenceSummary: countryData.oneSentenceSummary || '',
            keyFacts: countryData.keyFacts || [],
            peoples: countryData.peoples || [],
            languageNotes: countryData.languageNotes || '',
            historyHighlights: countryData.historyHighlights || [],
            notableFigures: countryData.notableFigures || [],
            musicAndArts: countryData.musicAndArts || [],
            foodCulture: countryData.foodCulture || [],
            oralTraditions: countryData.oralTraditions || [],
            knowledgeToPreserve: countryData.knowledgeToPreserve || [],
            recommendedPaths: countryData.recommendedPaths || [],
            relatedThemes: countryData.relatedThemes || [],
            sourceQuality: countryData.sourceQuality || 'draft',
            discoveryIntro: countryData.discoveryIntro || countryData.description || '',
            lastUpdated: countryData.lastUpdated || '2026',
            officialName: countryData.officialName || countryData.nameFr,
            region: countryData.region || '',
            subregion: countryData.subregion || '',
            demonym: countryData.demonym || '',
            timeZone: countryData.timeZone || '',
            callingCode: countryData.callingCode || '',
            internetTld: countryData.internetTld || '',
            drivingSide: countryData.drivingSide || '',
            independenceDate: countryData.independenceDate || '',
            governmentType: countryData.governmentType || '',
            economicOverview: countryData.economicOverview || '',
            climate: countryData.climate || '',
            bestTimeToVisit: countryData.bestTimeToVisit || '',
            safetyNote: countryData.safetyNote || '',
            etiquette: countryData.etiquette || '',
            transport: countryData.transport || '',
            connectivity: countryData.connectivity || '',
            visaNote: countryData.visaNote || '',
            healthAdvice: countryData.healthAdvice || '',
            ...
            placesToDiscover: countryData.placesToDiscover || [],
            experiences: countryData.experiences || [],
            practicalTips: countryData.practicalTips || [],
            sourceNotes: countryData.sourceNotes || [],
